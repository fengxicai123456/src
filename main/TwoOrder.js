...
class User extends Component {
    ...
    render () {
        return (
            ...
            <span className="phone">{"电话:"+1384381438}</span>
            </p>
    ...
    render () {
        return (
            ...
            <div className="ticket">
	            <span><i></i>是否使用发票</span>
		        <section title=".slideOne">
		        <div className="slideOne">
			    <input type="checkbox" value="None" id="slideOne" name="check" checked="checked"/>
    ...
    render() {
        ...
        return (
            <div className="page" id="list-page">
                <Header title="确认订单" hasSearch={true} rightBtn={" "} hasBack={false}/>           
